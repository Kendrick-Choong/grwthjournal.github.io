...
<!--					text-shadow: 0px 1px 1px rgb(146, 109, 46);-->
				</header>
				<br>
				<div class="content" style="background-color: ghostwhite; color: black; font-size:1.4rem; border-radius: 2rem;">
					...
					<form method="Post" action="promptEditInsert.php">
						<section>
							<textarea style="border:none; background-color: ghostwhite; color: black; font-size:1.4rem; border-radius: 2rem;" name="prompt_response" rows="12" cols="50" maxlength="500" placeholder="Release your thoughts here"><?php echo $prompt_response; ?></textarea>
						</section>
						<br />
