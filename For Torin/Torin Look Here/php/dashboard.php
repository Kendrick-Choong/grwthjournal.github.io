...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "SELECT grwth_prompt_name.user_prompt_id, grwth_prompt_name.prompt
            FROM grwth_prompt_name
            WHERE grwth_prompt_name.user_id = $user_id and (grwth_prompt_name.user_prompt_id = $prompt_id1 or grwth_prompt_name.user_prompt_id = $prompt_id2)";
